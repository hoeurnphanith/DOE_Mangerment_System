  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 text-primary">
        <h4>
          <i class="fas fa-graduation-cap"></i>​ប្រភេទអ្នកប្រើប្រាស់ : Admin
        </h4>
      </div>
    </div>
  </div><!-- /.container-fluid -->
            ...
            <div class="card-body table-responsive p-0">
             <div class="col-sm-12">
              <table id="example" style="min-width: max-content;" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <tbody>
                 <?php
                $users = $obj->fun_displaydata("tbl_users where User_Type='doe'");
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <?php
            $doe_staff = $obj->fun_displaydata("tbl_doe");
            
            ?>
            <label>ជ្រើសរើសសាលារៀន <span style="color:red">*</span></label>

            <select class="custom-select form-control-border" name="DOE_ID" id="DOE_ID" required="" onchange="singleSelectChangeValue()">
              <?php

              foreach($doe_staff as $records){
                $DOE_ID = $records['DOE_ID'];
                $DOE_Name = $records['DOE_Name'];
                ?>
                <option value='<?php echo $DOE_ID; ?>' selected>
                  <?php echo $DOE_Name; ?>
                </option>
                <?php
              }
...
<script>
 function singleSelectChangeValue() {
        ...
        var selObj = document.getElementById("DOE_ID");
    ...
    $.ajax({
      type:"POST",
      url: "action/admin_insert_update.php",
