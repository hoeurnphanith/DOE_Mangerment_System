      ...
      <div class="modal-body">
        ...
        <div class="row">
         <div class="form-group col-sm-12" >
          ...
          ?> 
          <select class="form-control form-control-border border-width-2 " id="School_ID" name="School_ID">
            <?php foreach($school_id as $rows):?>
              <option value="<?php echo $rows['School_ID']; ?>"
                <?php if($_SESSION['User_Name'] == $rows['School_ID']) 
 ...
 <div class="col-sm-12" style="text-align-last: left;">
   <div class="row">
    ...
    <div class="col-sm-3">
      ...
      <select class="custom-select form-control-border border-width-2" name="dob_province_name" id="dob_province_name" required="" 
...
<div class="col-sm-12" style="    margin-bottom: 10px;">
 <div class="row" style="text-align-last: left;" >
   <div class="form-group col-sm-4" >
    ...
    <input  type="text" class="form-control form-control-border border-width-2 "  name="family_status" id="family_status">
  </div>
