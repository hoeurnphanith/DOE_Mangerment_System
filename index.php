          ...
          <div class="login-wrap p-3 p-md-5">
           ...
           <form method="post" action="user_login.php">
            ...
            <div class="form-group" style="height: calc(2em + .75rem + 2px);" >
              <button type="submit" class="form-control rounded submit px-3" name="Login_user" style="background-color: #0081d6 !important; color: white;">ចូល</button>
            </div>
            ...
            <div class="col-sm-6">
              <a href="admin/admin_login.php" class="btn btn-danger" style="color: white; background-color: red;"> Admin</a>
            </div>
          </form>
