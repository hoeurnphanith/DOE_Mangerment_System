    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 text-primary">
          <h4>
            <i class="fas fa-graduation-cap"></i>​ មុខវិជ្ជា
          </h4>
        </div>
      </div>
    </div><!-- /.container-fluid -->
         ...
         <div class="row">
           <div class="card-body table-responsive p-0">
             <div class="col-sm-12">
              ...
              <thead>
                <tr>
                  <th style="width: 40%;">មុខវិជ្ជា</th>
    ...
    <div class="modal-content">
      ...
      <form action="javascript:void(0)" id="userInserUpdateForm" name="userInserUpdateForm" class="form-horizontal" method="POST">
         <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control" id="Subject_ID" hidden="" name="Subject_ID" placeholder="Subject_ID" value="" >
          </div>
        </div>  
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control form-control-border" id="Subject" name="Subject" placeholder="មុខវិជ្ជា" value="" maxlength="50" required="">
          </div>
        </div>  
...
<script>
  $(document).ready(function($){
    ...
    $.ajax({
      type:"POST",
      url: "../action/subject_insert_update.php",
