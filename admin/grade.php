    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 text-primary">
          <h4>
            <i class="fas fa-graduation-cap"></i> កម្រិតថ្នាក់
          </h4>
        </div>
      </div>
    </div><!-- /.container-fluid -->
             ...
             <div class="col-sm-12">
              ...
              <thead>
                <tr>
                  ...
                  <th style="width: 40%;">កម្រិតថ្នាក់</th>
                  <th style="width: 20%">ឧបករណ៌</th>
                </tr>
              </thead>
              <tbody>
                <?php
    ...
    <div class="modal-content">
      ...
      <form action="javascript:void(0)" id="userInserUpdateForm" name="userInserUpdateForm" class="form-horizontal" method="POST">
         <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control form-control-border" id="Grade_ID" hidden="" name="Grade_ID" placeholder="Grade_ID" value="" >
          </div>
        </div>  
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control form-control-border" id="Grade_Name" name="Grade_Name" placeholder="កម្រិតថ្នាក់" value="" maxlength="50" required="">
          </div>
        </div>  
        <!-- <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control form-control-border" id="Decription  " name="Decription" placeholder="ផ្សេងៗ" value="" maxlength="50">
          </div>
        </div> -->
...
<script>
  $(document).ready(function($){
    ...
    $.ajax({
      type:"POST",
      url: "../action/grade_insert_update.php",
