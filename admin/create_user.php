  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 text-primary">
        <h4>
          <i class="fas fa-graduation-cap"></i>​ គណនីប្រើប្រាស់ ផ្នែកសាលារៀន
        </h4>
      </div>
    </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="modal-dialog">
    ...
    <div class="form-group">
      <div class="col-sm-12">
       ...
       <input type="text" class="form-control form-control-border" id="User_Type" required="" name="User_Type" placeholder="ប្រភេទអ្នកប្រើប្រាស់" readonly="" value="school">
     </div>
   </div> 
