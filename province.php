    ...
    <div class="modal-content">
      ...
      <form action="javascript:void(0)" id="userInserUpdateForm" name="userInserUpdateForm" class="form-horizontal" method="POST">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control" id="province_Name" name="province_Name" placeholder="ឈ្មោះខេត្ដ" value="" maxlength="50" required="">
          </div>
        </div>  
        <div class="form-group">
          <div class="col-sm-12">
            <input type="text" class="form-control" id="Postcode" name="Postcode" placeholder="លេខកូដខេត្ដ" value="" maxlength="50" required="">
          </div>
        </div>
