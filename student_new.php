               ...
               <div class="col-sm-12">
                <table id="example" class="table table-bordered table-hover dataTable dtr-inline" style="font-size: 16px; min-width: max-content; " role="grid"​ style="font-family: 'Kantumruy', sans-serif;" aria-describedby="example2_info">
                  ...
                  <tbody>
                    ...
                    $student = $obj->fun_displaydata("tbl_student WHERE School_ID = '$School_ID'");
                    foreach($student as $records){
                      ...
                      <tr>
                        ...
                        <td><a href="javascript:void(0)" onclick="archiveFunction()" class="btn btn-warning edit text-white" data-id="<?php echo $ID_Student;?>">អាណាព្យាបាល</a></td>


                        <td>
                          <a href="javascript:void(0)" onclick="archiveFunction()" class="btn btn-info edit fas fa-eye text-white" data-id="<?php echo $ID_Student;?>"></a>
