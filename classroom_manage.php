    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 text-primary">
          <h4>
            <i class="fas fa-graduation-cap"></i> គ្រប់គ្រងបន្ទប់សិក្សា
          </h4>
        </div>
        <div class="col-sm-6 text-primary">
          <h4>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="nav justify-content-end">
                <a href="print_classroom_stu.php?key=<?php echo $_SESSION['key_stu'];?>"  class="btn btn-success text-white" data-id="<?php echo $_SESSION['key_stu']; ?>">
                  <i class="fas fa-print"> Print</i></a>&nbsp &nbsp
...
<?php require('action/includes/classroom_student_modal.php'); ?>
</div>
...
<script>
  $(document).ready(function($){
    ...
    $.ajax({
      type:"POST",
      url: "action/classroom_student_edit.php",
      data: { id: id },
      dataType: 'json',
    ...
    $.ajax({
      type:"POST",
      url: "action/classroom_student_insert_update.php",
    ...
    $.ajax({
      type:"POST",
      url: "action/classroom_student_delete.php",
      data: { id: id },
      dataType: 'json',
      success: function(res){
        window.location.reload();
