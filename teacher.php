    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 text-primary">
          <h4>
            <i class="fas fa-graduation-cap"></i> ព័ត៌មាន គ្រូសរុប
          </h4>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                  ...
                  foreach($student as $records){
                    ...
                    <tr>
                     ...
                     <!--  <td><?php echo $POB_Province; ?></td>
                      ...
                      <td>
                        <a href="javascript:void(0)" onclick="archiveFunction()" class="btn btn-info edit fas fa-eye text-white" data-id="<?php echo $ID_Teacher;?>"></a>
  ...
  <script>
    $(document).ready(function($){
      $('#addnew').click(function(){
        ...
        $('#userModel').html("បញ្ចូល-(ព័ត៌មានគ្រូ)");
    ...
    $.ajax({
      ...
      success: function(res){
        $('#userModel').html("កែប្រែ-(ព័ត៍មានគ្រូ)");
        $('#user-model').modal('show');
